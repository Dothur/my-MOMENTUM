const quotes = [
    ...
    {
        quotes: "절대 포기하지마라. 장벽에 부딪히거든, 그것이 절실함을 나에게 물어보는 장치에 불과하다는 것을 잊지마라.",
        author: "랜디 포시",
    },
    {
    ...
    {
        quotes: "시도해보지 않고는 누구도 자신이 얼마만큼 해낼 수 있는지 알지 못한다.",
        author: "푸블릴리우스 시루스",
    },
    {
        quotes: "성공을 위한 세 가지 열쇠는 이것이다. 첫째는 끈기, 둘째는 끈기, 셋째도 끈기",
        author: "이소룡",
    },
    {
        quotes: "성공의 커다란 비결은 결코 지치지 않는 인간으로 인생을 살아가는 것이다.",
        author: "알버트 슈바이처",
    }
]; //명언 10가지 배열
